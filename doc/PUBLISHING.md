...
- repository: `geetorusai/companies-tool`

The repo intentionally publishes a single package. There is no workspace version rewrite step like the main Geetorus repo needs.

## Version Formats

`companies.sh` follows the same semver-safe calendar versioning as Geetorus:
